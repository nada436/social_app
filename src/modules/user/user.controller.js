...
import { confirm_schema, login_schema, reassign_password, replace_email_schema, share_schema, signup_schema, update_email_schema, update_role_schema, update_schema } from './user.validation.js';
import { confirm, dash_board, forget_password, login, re_assign, refesh_token, replace_email, share_profile, sign_up, social_login, update_email, update_role, update_userinfo} from "./user.serves.js";
...
user_routes.get('/login',validation(login_schema),login)
